...
$peers = ping_peers();
$audit = get_audit(80);
$stat = ['AppsBank'=>['in'=>0,'out'=>0,'fail'=>0],'AppsEcommerce'=>['in'=>0,'out'=>0,'fail'=>0],'AppsTravel'=>['in'=>0,'out'=>0,'fail'=>0]];
foreach ($audit as $a) {
...
layout_start('Monitor Integrasi', 'Status realtime dan log REST API antar 3 sistem peer');
?>
