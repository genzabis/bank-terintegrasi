...
start "AppsEcommerce :8001"  /D "%ROOT%apps_ecommerce"  cmd /k %PHP_BIN% -S localhost:8001 -t "%ROOT%apps_ecommerce"
start "AppsPendidikan :8002" /D "%ROOT%apps_pendidikan" cmd /k %PHP_BIN% -S localhost:8002 -t "%ROOT%apps_pendidikan"
start "AppsTravel :8003"     /D "%ROOT%apps_travel"     cmd /k %PHP_BIN% -S localhost:8003 -t "%ROOT%apps_travel"
