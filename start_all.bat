...
start "AppsBank :8000"       /D "%ROOT%apps_bank"       cmd /k %PHP_BIN% -S localhost:8000
start "AppsEcommerce :8001"  /D "%ROOT%apps_ecommerce"  cmd /k %PHP_BIN% -S localhost:8001
start "AppsPendidikan :8002" /D "%ROOT%apps_pendidikan" cmd /k %PHP_BIN% -S localhost:8002
start "AppsTravel :8003"     /D "%ROOT%apps_travel"     cmd /k %PHP_BIN% -S localhost:8003
